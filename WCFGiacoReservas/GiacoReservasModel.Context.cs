...
public partial class GiacoReservaEntities : DbContext
{
    ...
    public virtual int usp_InsertarPersonal(string nombre, string apellido, string dni, Nullable<decimal> costo_hora, byte[] foto, string telefono, string correo, Nullable<int> tipo, string creadoPor, string creadoPor1, Nullable<int> estado)
    {
    ...
    public virtual ObjectResult<usp_ConsultarArtistaCostoHora_Result> usp_ConsultarArtistaCostoHora(Nullable<decimal> costoMinimo, Nullable<decimal> costoMaximo)
    {

        var costoMinimoParameter = costoMinimo.HasValue ?
            new ObjectParameter("CostoMinimo", costoMinimo) :
            new ObjectParameter("CostoMinimo", typeof(decimal));


        var costoMaximoParameter = costoMaximo.HasValue ?
            new ObjectParameter("CostoMaximo", costoMaximo) :
            new ObjectParameter("CostoMaximo", typeof(decimal));


        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_ConsultarArtistaCostoHora_Result>("usp_ConsultarArtistaCostoHora", costoMinimoParameter, costoMaximoParameter);
    }


    public virtual ObjectResult<usp_ConsultarPersonalTipo_Result> usp_ConsultarPersonalTipo(string tipo)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_ConsultarPersonalTipo_Result>("usp_ConsultarPersonalTipo", tipoParameter);
    }


    public virtual ObjectResult<sp_ConsultarClientesPorEstado_Result> sp_ConsultarClientesPorEstado(string estado)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_ConsultarClientesPorEstado_Result>("sp_ConsultarClientesPorEstado", estadoParameter);
    }
